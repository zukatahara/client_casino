...
const TaiXiuHistory = ({
  ...
  return (
    <div className="luzi-map-wp">
      <Tabs defaultValue="account" className="w-full">
        <TabsList className="grid p-0 w-2/3 mx-auto grid-cols-2 bg-transparent border border-slate-100 rounded-3xl">
          <TabsTrigger
            className="rounded-3xl flex-1 data-[state=active]:bg-[#4a69ff] data-[state=active]:text-white"
            value="account"
          >
            {t("tai xiu")}
          </TabsTrigger>
