                      ...
                      if (game.week_days.includes(d)) {
                        return (
                          <li
                            ...
                            className={cn(
                              "lotteryitem",
                              type === game.name ? "border-2 border-main" : ""
                            )}
                          >
                            {item.menu_id !== 9 && (
                              <img
