...
const HelpMobilePage = () => {
  ...
  const help = [
    {
      title: t("huong_dan_nguoi_moi", { ns: "all" }),
      value: (
        <>
          <div className="reshtml">
    ...
    },
    {
      ...
      value: (
        <>
          <div data-v-10d60438 className="reshtml">
            <p style={{ marginTop: 10, marginBottom: 5, lineHeight: "1.5em" }}>
              <strong>
      ...
      value: (
        <div data-v-10d60438 className="reshtml">
          ...
          <ol className=" list-paddingleft-2">
            <li>
              <p
                style={{ marginTop: 10, marginBottom: 5, lineHeight: "1.5em" }}
              >
          ...
          <p style={{ marginTop: 10, marginBottom: 5, lineHeight: "1.5em" }}>
            <strong> {t("sua_doi_bo_sung_cac_quy_pham", { ns: "all" })}</strong>
          </p>
          <p style={{ marginTop: 10, marginBottom: 5, lineHeight: "1.5em" }}>
        ...
        <div className="van-nav-bar van-nav-bar--fixed" style={{ zIndex: 20 }}>
          <div className="van-nav-bar__content">
            ...
            <div className="van-nav-bar__title van-ellipsis">
              <p> {content ? content.title : t("tro_giup", { ns: "all" })} </p>
            </div>
          </div>
        </div>
        <div
          ...
          className="scrollList scroll-list"
        >
          <div className="wrapper-tontent">
              ...
              <div className="flex flex-col w-full">
                {help.map((item, index) => (
                  <div
                    ...
                    className="text-base text-slate-200 px-2 py-4 border-b border-slate-500 relative"
                    key={index}
                  >
                    {item.title}
            ...
            {content && (
              <div className="p-4 text-slate-200 text-sm">{content.value}</div>
            )}
          </div>
        </div>
      </div>
